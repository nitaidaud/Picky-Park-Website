  ...
  he: {
    translation: {
      ...
      aboutUs: {
        ...
        third:
          "כרגע האפליקציה היא חינמית אינה דורשת כל תשלום. אתם יכולים פשוט להוריד את האפליקציה ולהתחיל להשתמש בה מיד. Picky משפרת כל הזמן את האפליקציה שלה ומוסיפה תכונות ושירותים חדשים כדי לשפר את חווית החניה שלך.",
      },
      footer: {
        title: "צרו קשר",
