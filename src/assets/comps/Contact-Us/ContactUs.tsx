    ...
    <div className="h-fit min-h-screen w-full flex flex-col 2xl:flex-row items-center justify-center px-10">
      ...
      <div className="w-fit h-full relative">
        <iframe
          ...
          height="600px"
        ></iframe>
        <div className="flex absolute bg-black h-14 w-44 lg:h-10 lg:w-36 min-w-fit right-3 bottom-3 rounded-full items-center text-balance hover:scale-110 duration-300 hover:bg-slate-500 play-text uppercase font-semibold">
